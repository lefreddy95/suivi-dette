...
const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* === SECTION 2b : DETTE CAMION PIZZA (legacy) - RETIREE === */}
      {/* L'utilisateur a decide de retirer l'affichage de la dette speciale
          camion-pizza. La transaction Kuidi "camion" reste en DB si deja creee
          par la migration, mais n'est plus mise en avant dans le Dashboard. */}
